...
namespace Shuyu.Cards
{
    ...
    public class YanShenFaZhang : ModCardTemplate
    {
        ...
        {
            Node2D? vfxNode = VFXUtil.PlaySimple(SceneHelper.GetScenePath("vfx/vfx_heavy_blunt"), NCombatRoom.Instance?.GetCreatureNode(cardPlay.Target)?.VfxSpawnPosition ?? Vector2.Zero, 2f);
            if (vfxNode != null)
            {
                vfxNode.Modulate = new Color("#7cffff");
            }
