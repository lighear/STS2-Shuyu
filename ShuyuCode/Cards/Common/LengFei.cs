...
namespace Shuyu.Cards
{
    ...
    public class LengFei : ModCardTemplate
    {
        ...
        {
            Node2D? vfxNode = VFXUtil.PlaySimple(SceneHelper.GetScenePath("vfx/vfx_spore_impact"), NCombatRoom.Instance?.GetCreatureNode(cardPlay.Target)?.VfxSpawnPosition ?? Vector2.Zero, 2f);
            if (vfxNode != null)
            {
                vfxNode.Modulate = new Color("#ffffff");
            }
