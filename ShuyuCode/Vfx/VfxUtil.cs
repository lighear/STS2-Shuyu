...
public static class VFXUtil
{
    ...
    public static void PreloadScenes()
    {
        ...
        var paths = new List<string>
        {
            ...
            $"{PowerVfxPath}/vfx_ShiTanPower.tscn",
            ...
            $"{CardVfxPath}/vfx_BingShuangChongJi.tscn",
            $"{CardVfxPath}/vfx_JiBingFengBao.tscn",
            $"{CardVfxPath}/vfx_CuiHuaGuangShuLaser.tscn",
            $"{CardVfxPath}/vfx_YinZhiShu.tscn",
            $"{CardVfxPath}/vfx_JueWangYongChang.tscn",
            $"{CardVfxPath}/vfx_YuJiaXue.tscn",
            $"{CardVfxPath}/vfx_HongNi.tscn",
            ...
            $"{CardVfxPath}/vfx_JinShuJieJieEdge.tscn",
            $"{CardVfxPath}/vfx_JinShuJieJieShield.tscn",
        };
